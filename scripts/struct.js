...
struct.getCaretPosition = function(editableDiv) {
...
struct.setCursorToEndOf = function (editableDiv)
{
   var childNodes = editableDiv.childNodes;
   for(i=0;i<childNodes.length;i++) {
        child = childNodes[i];
        if (child.tagName && child.tagName === "BR") {
                   editableDiv.removeChild(child);
        }
   }
